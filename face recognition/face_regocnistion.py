...
dataset = cv2.CascadeClassifier('data_faces.xml')
capture = cv2.VideoCapture(0)

face_1 = np.load('faces/jaspreetsingh.npy').reshape(50,50*50)
face_2 = np.load('faces/harpreetsingh.npy').reshape(50,50*50)
face_3 = np.load('faces/ajinder.npy').reshape(50,50*50)

users = {0:"jaspreet", 1:"harpreet",2:"ajinder"}

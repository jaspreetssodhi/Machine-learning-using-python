...
capture = cv2.VideoCapture('sachin_c.mp4')

face_1 = np.load('sachin.npy').reshape(50,50*50)
face_2 = np.load('faces/jaspreetsingh.npy').reshape(50,50*50)

users = {0:"sachin", 1:"jaspreet"}
